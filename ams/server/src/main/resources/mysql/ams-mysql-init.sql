...
(
    ...
    `db_name`                       varchar(128) NOT NULL COMMENT 'Database name',
    `table_name`                    varchar(128) NOT NULL COMMENT 'Table name',
    `current_snapshot`              BINARY NOT NULL  COMMENT 'Base table current snapshot id',
    `last_optimized_snapshot`       BINARY NOT NULL  COMMENT 'last optimized snapshot id',
